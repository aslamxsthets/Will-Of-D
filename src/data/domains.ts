...
export const domains: Domain[] = [
  {
    ...
    description: 'The backbone of the community. From web development to cybersecurity, AI/ML to cloud computing — this is where ideas become reality.',
  ...
  },
  {
    ...
    description: 'Capturing moments, creating content, and telling the community\'s story through visual media.',
  ...
  },
  {
    id: 'community',
    title: 'COMMUNITY',
    tagline: 'A community works better together.',
