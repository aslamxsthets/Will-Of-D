      ...
      <div className="relative py-16 md:py-24 px-4 text-center overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          <div className="flex justify-center gap-6 mt-8">
            <a href="#" className="text-white/40 hover:text-comic-red transition-colors" aria-label="Instagram">
              <Instagram size={20} />
            </a>
            <a href="#" className="text-white/40 hover:text-comic-red transition-colors" aria-label="Twitter">
              <Twitter size={20} />
            </a>
            <a href="#" className="text-white/40 hover:text-comic-red transition-colors" aria-label="Discord">
            ...
            <a href="#" className="text-white/40 hover:text-comic-red transition-colors" aria-label="GitHub">
              <Github size={20} />
            </a>
          </div>
        </div>
