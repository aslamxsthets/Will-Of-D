...
const discordInviteUrl = 'https://discord.gg/eMzua49N5u';
      ...
      <div className="relative py-16 md:py-24 px-4 text-center overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          <div className="flex justify-center gap-6 mt-8">
            ...
            <a href="https://discord.gg/eMzua49N5u" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-comic-red transition-colors" aria-label="Discord">
